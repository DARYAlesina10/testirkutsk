...
export class ProductsController {
  constructor(private prisma: PrismaService, @InjectQueue('partner-article') private readonly partnerArticleQueue: Queue) {}
  @Get() list() { return this.prisma.product.findMany({ orderBy: { createdAt: 'desc' } }); }
