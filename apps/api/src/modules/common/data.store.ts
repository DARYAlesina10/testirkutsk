...
export class DataStore {
  ...
  products = [{ id: 'p1', title: 'Телефон X', slug: 'telefon-x', categoryId: 'c1', currentPrice: 10000, oldPrice: 12000, marketUrl: 'https://market.yandex.ru/product--telefon-x/1', marketArticle: null as string | null, partnerArticle: null as string | null }];
